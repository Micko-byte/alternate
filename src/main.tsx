  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-paper p-6">
      <div className="grid max-w-lg gap-4">
        <img src="/brand/vaa-logo.png" alt="VAA ALTERNATE" className="h-20 w-auto justify-self-start dark:hidden" />
        <img src="/brand/vaa-logo-white.png" alt="" aria-hidden className="hidden h-20 w-auto justify-self-start dark:block" />
